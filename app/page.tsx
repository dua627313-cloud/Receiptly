...
import { ArrowRight, ShieldIcon } from "lucide-react";
        ...
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="mx-auto max-w-700px text-gray-500 md:text-xl dark:text-gray-400">
              Scan, Analyze, and Organize Your Receipts with AI-Powered Precision.Save time and stay organized effortlessly. Try it now!
            </p>
          </div>
        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="max-w-700px text-gray-500 md:text-xl dark:text-gray-400">
              Our AI-powered receipt scanning app offers a range of powerful features designed to make your life easier.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="flex flex-col items-center space-y-2 border border-gray-200 rounded-lg p-6 dark:border-gray-800">
              ...
              <h3 className="text-xl font-bold">Expose Insights</h3>
              <p className="text-gray-500 dark:text-gray-400 text-center">
                Generate reports and visualize your spending patterns with ease.
              </p>
            </div>
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="text-center mb-12">
      ...
      <p className="mt-4 text-gray-500 dark:text-gray-400">
        Start free and manage your receipts smarter with AI.
      </p>
    </div>

    <div className="flex justify-center">
      <div className="w-full max-w-sm border border-gray-200 dark:border-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300">
        ...
        <button className="w-full py-3 rounded-lg bg-black text-white dark:bg-white dark:text-black font-medium hover:opacity-90 transition">
          Sign Up Free
        </button>
    ...
    <div className="container px-4 md:px-6 py-8 mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-xl font-semibold">Receiptly</span>
        </div>
        <div className="mt-4 md:mt-0">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Receiptly. The smarter way to manage your receipts. &copy; 2026 All rights reserved.
          </p>
