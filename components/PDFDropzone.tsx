    ...
    return (
        <DndContext sensors={sensors}>
            <div className="w-full max-w-md mx-auto">
                    ...
                    {isUploading ? (
                        ...
                        <>
                            ...
                            <p className="mt-2 text-sm text-gray-600">
                                Please sign in to upload your receipts.
                            </p>
                        </>
                    ) : (
                        <>
                            <CloudUpload className="mx-auto h-12 w-12 text-gray-400" />
                            <p className="mt-2 text-sm text-gray-600">
                                Drag and drop your PDF receipts here, or click to select files.
                            </p>
                ...
                {featureUsageExceeded && (
                    <div className="mt-4 flex items-center p-3 bg-red-50 border border-red-200 rounded-md text-red-600">
